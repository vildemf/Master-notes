...
We now have all the expressions neeeded to calculate the gradient of the local energy with respect to the RBM parameters $\frac{\partial \langle E_L \rangle}{\partial \alpha_i}$.
